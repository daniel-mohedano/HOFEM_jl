...
modules = HOFEM_jl.Parsing.parse(parser, [
  ...
  "../test_HOFEM_library_features/fake_HOFEM_library.F90",
  "../test_HOFEM_library_features/fake_MUMPS_driver_mod.F90",
  "../test_HOFEM_library_features/fake_SparseMatrix_mod.F90",
])
