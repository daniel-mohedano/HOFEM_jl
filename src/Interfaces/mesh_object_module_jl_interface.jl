...
function get_total_number_of_dofs(mesh::MeshObject)::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_total_number_of_dofs(mesh.handle)::Cint
end

function get_total_number_of_elements(mesh::MeshObject)::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_total_number_of_elements(mesh.handle)::Cint
end

function get_total_number_of_points(mesh::MeshObject)::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_total_number_of_points(mesh.handle)::Cint
end

function get_mesh_geometrical_order(mesh::MeshObject)::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_mesh_geometrical_order(mesh.handle)::Cint
end

function get_mesh_variational_order(mesh::MeshObject)::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_mesh_variational_order(mesh.handle)::Cint
end

function is_this_element_filling_rhs(mesh::MeshObject, elemID::Ref{Cint})::Cuchar
	return @ccall _HOFEM_LIB_PATH.jl_is_this_element_filling_rhs(mesh.handle, elemID::Ref{Cint})::Cuchar
end

function get_topology_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Ptr{Cchar}
	return @ccall _HOFEM_LIB_PATH.jl_get_topology_of_this_element(mesh.handle, elemID::Ref{Cint})::Ptr{Cchar}
end

function get_material_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_material_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_curved_flag_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cuchar
	return @ccall _HOFEM_LIB_PATH.jl_get_curved_flag_of_this_element(mesh.handle, elemID::Ref{Cint})::Cuchar
end

function get_surfacesets_IDS_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_surfacesets_IDS_of_this_element(mesh.handle, elemID::Ref{Cint})::Ptr{Cint}
end

function get_faces_over_interior_region_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Ptr{Cuchar}
	return @ccall _HOFEM_LIB_PATH.jl_get_faces_over_interior_region_of_this_element(mesh.handle, elemID::Ref{Cint})::Ptr{Cuchar}
end

function get_boundary_condition_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_boundary_condition_of_this_element(mesh.handle, elemID::Ref{Cint})::Ptr{Cint}
end

function get_nodes_connectivity_of_this_element(mesh::MeshObject, elemID::Ref{Cint}, nodes::Ptr{Cint}, npe::Ref{Cint})::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_get_nodes_connectivity_of_this_element(mesh.handle, elemID::Ref{Cint}, nodes::Ptr{Cint}, npe::Ref{Cint})::Cvoid
end

function get_points_connectivity_of_this_element(mesh::MeshObject, elemID::Ref{Cint}, points::Ptr{Cint}, ppe::Ref{Cint})::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_get_points_connectivity_of_this_element(mesh.handle, elemID::Ref{Cint}, points::Ptr{Cint}, ppe::Ref{Cint})::Cvoid
end

function get_variational_order_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_variational_order_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_geometrical_order_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_geometrical_order_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_number_of_nodes_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_number_of_nodes_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_number_of_points_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_number_of_points_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_all_local_points_IDS_of_this_edge(mesh::MeshObject, elemID::Ref{Cint}, edge::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_all_local_points_IDS_of_this_edge(mesh.handle, elemID::Ref{Cint}, edge::Ref{Cint})::Ptr{Cint}
end

function get_all_local_points_IDS_of_this_face(mesh::MeshObject, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_all_local_points_IDS_of_this_face(mesh.handle, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
end

function get_local_points_with_fake_IDS_of_this_face(mesh::MeshObject, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_local_points_with_fake_IDS_of_this_face(mesh.handle, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
end

function get_all_local_nodes_IDS_of_this_edge(mesh::MeshObject, elemID::Ref{Cint}, edge::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_all_local_nodes_IDS_of_this_edge(mesh.handle, elemID::Ref{Cint}, edge::Ref{Cint})::Ptr{Cint}
end

function get_all_local_nodes_IDS_of_this_face(mesh::MeshObject, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_all_local_nodes_IDS_of_this_face(mesh.handle, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
end

function get_lagrange_local_nodes_of_this_face(mesh::MeshObject, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
	return @ccall _HOFEM_LIB_PATH.jl_get_lagrange_local_nodes_of_this_face(mesh.handle, elemID::Ref{Cint}, face::Ref{Cint})::Ptr{Cint}
end

function get_number_of_faces_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_number_of_faces_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_number_of_edges_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_number_of_edges_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_number_of_vertices_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_number_of_vertices_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_dof_per_volume_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_dof_per_volume_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_dof_per_face_of_this_element(mesh::MeshObject, elemID::Ref{Cint}, face::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_dof_per_face_of_this_element(mesh.handle, elemID::Ref{Cint}, face::Ref{Cint})::Cint
end

function get_dof_per_edge_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_dof_per_edge_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function get_dof_per_vertex_of_this_element(mesh::MeshObject, elemID::Ref{Cint})::Cint
	return @ccall _HOFEM_LIB_PATH.jl_get_dof_per_vertex_of_this_element(mesh.handle, elemID::Ref{Cint})::Cint
end

function create_element_type_objects_in_mesh(mesh::MeshObject)::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_create_element_type_objects_in_mesh(mesh.handle)::Cvoid
end

function deallocate_mesh_array_memory(mesh::MeshObject)::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_deallocate_mesh_array_memory(mesh.handle)::Cvoid
end
