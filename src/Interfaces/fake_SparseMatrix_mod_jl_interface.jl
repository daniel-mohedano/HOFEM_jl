...
function print_SparseMatrix_type(obj::SparseMatrix_type)
	@ccall _HOFEM_LIB_PATH.print_sparsematrix_type(obj.handle::Ptr{Cvoid})::Cvoid
end
...
function print_SparseMatrix_type(this::SparseMatrix_type)::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_print_SparseMatrix_type(this.handle)::Cvoid
end

function deallocate_SparseMatrix_type_components(this::SparseMatrix_type)::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_deallocate_SparseMatrix_type_components(this.handle)::Cvoid
end

function set_default_SparseMatrix_type(FEM_matrix::SparseMatrix_type)::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_set_default_SparseMatrix_type(FEM_matrix.handle)::Cvoid
end

function set_default_DenseRHS_type(DenseRHS::SparseMatrix_type)::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_set_default_DenseRHS_type(DenseRHS.handle)::Cvoid
end

function set_SparseMatrix_type(FEM_matrix::SparseMatrix_type, n::Ref{Cint}, mat_type_format::Ref{Cint}, flag_sym::Ref{Cint}, IRN::Ptr{Cint}, JCN::Ptr{Cint})::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_set_SparseMatrix_type(FEM_matrix.handle, n::Ref{Cint}, mat_type_format::Ref{Cint}, flag_sym::Ref{Cint}, IRN::Ptr{Cint}, JCN::Ptr{Cint})::Cvoid
end

function set_DenseRHS_type(DenseRHS::SparseMatrix_type, n::Ref{Cint}, mat_type_format::Ref{Cint}, flag_sym::Ref{Cint})::Cvoid
	return @ccall _HOFEM_LIB_PATH.jl_set_DenseRHS_type(DenseRHS.handle, n::Ref{Cint}, mat_type_format::Ref{Cint}, flag_sym::Ref{Cint})::Cvoid
end
